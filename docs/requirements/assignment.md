...
Этот документ хранит исходное техническое задание по проекту "Аватарница".

## Назначение

- Фиксировать требования в том виде, в котором они были получены из задания.
- Не смешивать исходное ТЗ с последующими уточнениями и решениями по реализации.
- Использовать как базовый источник при проверке полноты реализации.
