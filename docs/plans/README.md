...
- [04-observability-monitoring-stack-plan.md](./04-observability-monitoring-stack-plan.md) - план локального Prometheus, Jaeger, Grafana, Loki и OpenTelemetry Collector stack через compose override.
